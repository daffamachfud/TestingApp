...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        ...
        when {
            length.isEmpty() -> edt_length.error = "Field length is empty"
            width.isEmpty() -> edt_width.error = "Field width is empty"
            height.isEmpty() -> edt_height.error = "Field height is empty"
            else -> {
